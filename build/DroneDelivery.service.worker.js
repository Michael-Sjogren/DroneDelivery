...
const CACHE_NAME = "DroneDelivery-cache";
const OFFLINE_URL = "DroneDelivery.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["DroneDelivery.html","DroneDelivery.js","DroneDelivery.wasm","DroneDelivery.pck","DroneDelivery.offline.html","DroneDelivery.icon.png","DroneDelivery.apple-touch-icon.png"];
